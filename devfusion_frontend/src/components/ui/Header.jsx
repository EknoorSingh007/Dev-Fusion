                ...
                {isLoggedIn && (
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center space-x-3 px-4 py-2 text-sm text-destructive hover:bg-red-50 w-full transition-colors"
                    >
            ...
            <div className="pt-4 mt-4 border-t border-gray-200">
              <div className="space-y-2">
                ...
                {isLoggedIn && (
                  <button
                    onClick={handleLogout}
                    className="flex items-center space-x-3 px-4 py-3 rounded-lg text-sm text-destructive hover:bg-red-50 w-full transition-colors"
                  >
