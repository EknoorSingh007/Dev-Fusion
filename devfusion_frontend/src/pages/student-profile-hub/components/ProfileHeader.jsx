      ...
      <div className="px-6 pb-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500 mb-4">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span>{profile?.university || 'Your University'}</span>
                </div>
                {/* 🟢 THE FIX IS HERE 🟢 */}
                <div className="flex items-center space-x-1">
                  <Icon name="Calendar" size={16} />
                  {/* We now check if joined_date exists before formatting it */}
                  <span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6 pt-6 border-t border-gray-200">
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-900">{profile?.stats?.projects || 0}</div>
            <div className="text-sm text-gray-500">Projects</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-900">{profile?.stats?.collaborations || 0}</div>
            <div className="text-sm text-gray-500">Collaborations</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-900">{profile?.stats?.followers || 0}</div>
            <div className="text-sm text-gray-500">Followers</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-900">{profile?.stats?.endorsements || 0}</div>
