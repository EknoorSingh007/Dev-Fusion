...
const ProjectPreview = ({ formData, onEdit, onPublish, isPublishing }) => {
        ...
        <div className="border-t border-gray-200 pt-6">
          ...
          <div className="flex items-center space-x-4">
            <Image
              ...
              alt={mockCreatorData?.avatarAlt}
              className="w-12 h-12 rounded-full object-cover" />

            <div className="flex-1">
              <div className="flex items-center space-x-2">
                <h5 className="font-medium text-gray-900">{mockCreatorData?.name}</h5>
                <div className="flex items-center space-x-1">
                  <Icon name="Star" size={14} className="text-yellow-500 fill-current" />
                  <span className="text-sm text-gray-600">{mockCreatorData?.rating}</span>
                </div>
              </div>
              <p className="text-sm text-gray-600">
                {mockCreatorData?.year} • {mockCreatorData?.major} • {mockCreatorData?.university}
              </p>
              <p className="text-xs text-gray-500 mt-1">
                {mockCreatorData?.projectsCompleted} projects completed
              </p>
            </div>
